    ...
    <div class="row">
        ...
        <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
            <div class="form-group">
                ...
                <select name="tipo_comprobante" class="form-control">
                    <option value="Cedula">Boleta</option>
                    <option value="Rif">Factura</option>
                    <option value="Pasaporte">Ticket</option>
                </select>
        ...
        <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
            <div class="form-group">
                    ...
                    <input type="text" name="serie_comprobante"  value ="{{old('serie_comprobante')}}" class="form-control" placeholder="Serie de documento...">
                </div>
        </div>
            ...
            <div class="panel-body">
                ...
                <div class="col-lg-2 col-md-2 col-sm-2 col-xs-12">
                    <div class="form-group">
                        ...
                        <input type="number" name="pprecio_venta"  disabled id="pprecio_venta" class="form-control"
